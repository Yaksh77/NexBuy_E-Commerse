...
function ProductDetails() {
  ...
  return productData ? (
    <div>
      <div className="w-[99vw] h-[130vh] md:h-[100vh] flex items-center justify-start flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] lg:flex-row gap-[20px]">
        <div className="lg:w-[50vw] md:w-[90vw] lg:h-[90vh] h-[50vh] mt-[70px] flex items-center justify-center md:gap-[10px] gap-[30px] flex-col-reverse lg:flex-row">
          <div
            className="lg:w-[20%] md:w-[80%] h-[10%] lg:h-[80%] flex items-center
            justify-center gap-[50px] lg:gap-[20px] lg:flex-col flex-wrap"
          >
          ...
          <div className="lg:w-[60%] w-[80%] lg:h-[78%] h-[70%] border-[1px] border-[#80808049] rounded-md overflow-hidden">
            <img
              ...
              alt=""
              className="
            w-[100%] lg:h-[100%] h-[100%] text-[30px] text-white text-center rounded-md object-fill"
            />
          </div>
        </div>
        <div
        ...
        >
          ...
          <div className="flex items-center gap-1">
            ...
            <FaStar className="text-[20px] fill-amber-400" />
            <FaStar className="text-[20px] fill-amber-400" />
            <FaStarHalfStroke className="text-[20px] fill-amber-400" />
          ...
          <div className="flex flex-col gap-[10px] my-[10px]">
            ...
            <button
              className="text-[16px] active:bg-slate-500 cursor-pointer bg-[#495b61c9] py-[10px] px-[20px] rounded-2xl mt-[10px]
          ...
          <div className="w-[80%] text-[16px] text-white">
            ...
            <p>Easy resturn and exchange policy within 7 days</p>
          </div>
        </div>
      </div>
      <div className="w-[100%] min-h-[70vh] flex items-start justify-start flex-col bg-gradient-to-l from-[#141414] to-[#0c2025] overflow-x-hidden">
        ...
        <div
          className="w-[80%] md:h-[150px] h-[220px] bg-[#3336397c] border text-white text-[13px] md:text-[15px] lg:text-[20px] px-[10px]
        md:px-[30px] lg:ml-[100px] ml-[20px]"
        >
          <p className="w-[95%] h-[90%] flex items-center justify-center">
            At NexBuy, we offer a wide range of products designed to match every
            lifestyle and need. From the latest fashion trends and comfortable
            everyday wear to premium accessories and stylish essentials, our
            collection brings together quality, affordability, and modern
            design.
          </p>
        </div>
        <ReleatedProduct
          ...
          currentProdcutId={productData._id}
        />
      </div>
    </div>
  ) : (
