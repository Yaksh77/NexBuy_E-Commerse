...
import razorpay from "../assets/Razorpaylead.avif";
...
function PlaceOrder() {
  const { cartItem, products, setCartItem, getCartAmmount, deliveryFee } =
  ...
  return (
    <div className="w-[99vw] min-h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] flex items-center justify-center">
      <div className="lg:w-[50%] w-[100%] h-[100%] flex items-center justify-center lg:mt-[0px] mt-[90px]">
        <form
          action=""
          className="lg:w-[70%] w-[95%] w-[95%] lg:h-[70%] h-[100%]"
        >
          ...
          <div>
            ...
            items-center justify-center gap-[20px] absolute lg:right-[20%] bottom-[10%]
            right-[35%] border-[1px] border-[#80808049] ml-[30px] mt-[20px]"
      ...
      <div className="lg:w-[50%] w-[100%] min-h-[100%] flex items-center justify-center gap-[30px]">
        <div className="lg:w-[70%] w-[90%] lg:h-[100%] flex items-center justify-center gap-[10px] flex-col">
          ...
          <div className="w-[100%] h-[30vh] lg:h-[100px] flex items-start mt-[20px] lg:mt-[0px] justify-center gap-[50px]">
            ...
            <button
              className={`w-[200px] h-[50px] bg-gradient-to-t from-[#95b3f8] to-[white] text-[14px]
              px-[20px] rounded-sm text-[#332f6f] font-bold ${
                method === "COD"
                  ? "border-[5px] border-blue-900 rounded-sm"
                  : ""
              }`}
