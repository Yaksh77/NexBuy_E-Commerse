...
function Orders() {
  ...
  const fetchAllOrders = async () => {
    try {
      const response = await axios.get(`${serverUrl}/api/order/list-orders`, {
      ...
      <div className="w-[100%] h-[100%] flex items-center lg:justify-start justify-center">
        ...
        <div className="lg:w-[85%] md:w-[70%] h-[100%] lg:ml-[310px] md:ml-[250px] mt-[70px] flex flex-col gap-[30px] overflow-x-hidden py-[50px] ml-[100px]">
          ...
          {orders.map((order, index) => (
            <div
              className="w-[90%] h-[40%] bg-slate-600 rounded-xl flex lg:items-center items-start justify-between flex-col
              lg:flex-row p-[10px] md:px-[20px] gap-[20px]"
            >
