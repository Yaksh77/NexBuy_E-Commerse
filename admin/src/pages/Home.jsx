...
function Home() {
  ...
  const fetchCounts = async () => {
    try {
      ...
      const orders = await axios.get(`${serverUrl}/api/order/list-orders`, {
        withCredentials: true,
      });
  ...
  return (
    <div className="w-[100vw] h-[100vh] bg-gradient-to-l from-[#141414] to-[#0c2025] text-white relative">
      ...
      <div className="w-[70vw] h-[100vh] absolute left-[25%] flex items-start justify-start flex-col gap-[40px] py-[100px]">
        <h1 className="text-[35px] text-[#afe2f2]">NexBuy Admin Panel</h1>

        <div className="flex items-start justify-start gap-[50px] flex-col md:flex-row">
          <div
            className="text-[#dcfafd] w-[400px] max-w-[90%] h-[200px] bg-[#0000002e] flex items-center
        justify-center flex-col gap-[20px] rounded-lg shadow-sm shadow-black backdrop:blur-lg md:text-[25px] text-[20px] border-[1px] border-[#969595]"
          >
